        ...
        {loading ? (
          ...
          <>
            ...
            <div ref={scrollBodyRef} className="flex-1 overflow-y-auto p-5 space-y-4">
              ...
              {/* Attachments uploaded before message-level linkage existed (message_id NULL)
                  don't have a specific message bubble to render under, so they still show
                  here as task-level files. Anything uploaded going forward renders inline
                  under the message that sent it, above. */}
