...
// an attachment (the download pill rendered below the chat). Collapse it to a
// short note here so the user sees the intent, not the raw JSON directive —
// the actual download link lives in the pill, matched by filename.
